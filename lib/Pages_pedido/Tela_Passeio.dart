...
class _Tela_PasseioState extends State<Tela_Passeio> {
  ...
  List<Marker> _marcadorLocalPedido = [];
            ...
            body: Stack(
              children: [
                GoogleMap(
                  ...
                  markers: _marcadorLocalPedido.toSet(),
                  ...
                  onMapCreated: (controller) {
                    ...
                    final marker = Marker(
                        ...
                        infoWindow: InfoWindow(
                            title: widget.detalheCorrida["end_ponto"]),
                        position: LatLng(
                            latitude, longitude),
                        onDragEnd: ((newPosition) {
                          setState(() {
                            print("Nova posicaolat${newPosition.latitude}");
                            print("Nova posicaolat${newPosition.longitude}");
                          });
                        })
                    );
                    setState(() {
                      _marcadorLocalPedido.add(marker);
                      //_marcadorLocalPedido["0"] = marker;
                    });
                  },
                              ...
                              children: [
                                ElevatedButton.icon(
                                    icon: Icon(FontAwesomeIcons.directions,
                                      color: Colors.white54, size: 18.0,),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Text(_distanciaKM != null ? _distanciaKM + " " +
                              _TempoCorrida : "", style: TextStyle(
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              ...
                              Text(widget.detalheCorrida["nome_ponto"] != null
                                  ? widget.detalheCorrida["nome_ponto"]
                                  : "", style: TextStyle(
                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    launch(('tel://${widget
                                        .detalheCorrida["telefone"] != null
                                        ? widget.detalheCorrida["telefone"]
                                        : ""}'));
                                  },
                                  child: Container(
                                    height: 30.0,
                          ...
                          Row(
                            children: [
                              Image.asset("imagens/pickicon.png", height: 16,
                                  width: 16.0),
                              SizedBox(width: 18.0),
                              Expanded(
                                  child:
                                  Container(
                                    child: Text(
                                      widget.detalheCorrida["end_ponto"] != null
                                          ? widget.detalheCorrida["end_ponto"]
                                          : "",
                          ...
                          Row(
                            children: [
                              Image.asset(
                                "imagens/iconquantpedido.png", height: 16.0,
                                width: 16.0,),
                              SizedBox(width: 18.0),
                              Expanded(
                                  child:
                                  Container(
                                    child: Text(
                                      widget.detalheCorrida["quant_itens"] !=
                                          null ? widget
                                          .detalheCorrida["quant_itens"] +
                                          " itens" : "",
                                      style: TextStyle(fontSize: 18.0),
                                      overflow: TextOverflow.ellipsis,),
                                  ))
                        ...
                        children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              ...
                              Text("PEDIDO CANCELADO.", style: TextStyle(
                                  fontSize: 24.0, fontFamily: "Brand Bold"),),
                          ...
                          Row(
                            children: [
                              Image.asset("imagens/compass.png", height: 16.0,
                                width: 16.0,),
                              SizedBox(width: 18.0),
                              Expanded(
                                  child:
  ...
  Future<void> launchGoogleMaps(double lat, double lng) async {
    ...
    var fallbackUrl =
        'https://www.google.com/maps/search/?api=1&query=${lat.toString()},${lng
        .toString()}';
    try {
      bool launched =
      await launch(url, forceSafariVC: false, forceWebView: false);
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          GestureDetector(
                              child: Column(
                                children: <Widget>[
                                  Image.asset("imagens/wazeicon.png", width: 50,
                                    height: 50,),
                                  Text('Waze'),
                                ],
                              ),
                          ...
                          GestureDetector(
                              child: Column(
                                children: <Widget>[
                                  Image.asset(
                                    "imagens/googlemapsicon.png", width: 50,
                                    height: 50,),
 ...
 */
  ...
  Future<void> MotoboyChegou(String texto) {
    ...
    return _db.collection("Pedidos")
        .doc(widget.detalheCorrida["id_doc"])
        .update(dados);
  ...
  void locatePosition() async {
    ...
    if (posicao_atual != null && widget.detalheCorrida != null) {
      _KGooglePlex =
          CameraPosition(
              target: LatLng(posicao_atual.latitude, posicao_atual.longitude),
              zoom: 14);
    }
  }
...
*/
    ...
    void _moveToSignInScreen(BuildContext context) =>
        Navigator.pushNamedAndRemoveUntil(
            context, Pedidos_em_Entrega.idScreen, (route) => false);
  }
/*
class MapUtils {
