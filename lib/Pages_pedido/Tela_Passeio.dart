...
class _Tela_PasseioState extends State<Tela_Passeio> {
            ...
            GoogleMap(
              ...
              onMapCreated: (controller) {
                ...
                final marker = Marker(
                    ...
                    markerId: MarkerId('0'),
                    infoWindow:
                        InfoWindow(title: widget.detalheCorrida["end_ponto"]),
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            widget.detalheCorrida["nome_ponto"] != null
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                launch(
                                    ('tel://${widget.detalheCorrida["telefone"] != null ? widget.detalheCorrida["telefone"] : ""}'));
                              },
                              child: Container(
                                height: 30.0,
                                width: 30.0,
                      ...
                      Row(
                        children: [
                          Image.asset("imagens/pickicon.png",
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                              child: Container(
                            child: Text(
                              widget.detalheCorrida["quant_itens"] != null
                      ...
                      Padding(
                        ...
                        child: Container(
                            ...
                            child: ElevatedButton.icon(
                                ...
                                label:
                                    Text(_TextoBotao ? "Finalizar" : "Cheguei"),
                                style: ElevatedButton.styleFrom(
                                  padding:
  ...
  void DialogCheguei() {
    NAlertDialog(
        ...
        title: Text("Atenção"),
        content: Text("Você realmente chegou no local?"),
        actions: <Widget>[
          TextButton(
              child: Text("NÃO",
                  style: TextStyle(
  ...
  void MotoboyFinalizou() {
    NAlertDialog(
        dialogStyle: DialogStyle(
            ...
            backgroundColor: Theme.of(context).dialogBackgroundColor),
        title: Text("Atenção"),
        content: Text("Você realmente finalizou o pedido?"),
        actions: <Widget>[
          TextButton(
              child: Text("NÃO",
                  style: TextStyle(
  ...
  Future<void> FinalizarPedido() {
    ...
    _db
      ...
      if (documentSnapshot.exists) {
        ...
        int meusItens = int.parse(dados["n_pedidos"]);
        ...
        ToastMensagem(
            "Aconteceu um erro, tente novamente mais tarde.", context);
      }
    });
