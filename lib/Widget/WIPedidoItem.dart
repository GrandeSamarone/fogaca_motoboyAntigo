...
class WIPedidoItem extends StatelessWidget {
  ...
  //     showDialog(
  //         context:context,
  //         builder: (BuildContext context)=>DialogPedidoFinalizado(pedido: pedido) );
  //   }else if(pedido["situacao"]=="Buscando..."){
  //     showDialog(
  //         context:context,
  //         builder: (BuildContext context)=>DialogAguarde(pedido: pedido) );
  //   }else {
  //     showDialog(
  //         context:context,
  //         builder: (BuildContext context)=>DialogDetalhePedido(pedido: pedido) );
  //   }}
